...
: Klassens fordeling. ABO-kolonnerne summerer til $N$ og 100 %, og det samme gør de to RhD-kolonner. {#tbl-fordeling}

3. Lav et søjlediagram for klassens fire ABO-andele. Sammenlign med referenceværdierne i undervisningsmaterialet (de ældre vejledninger bruger cirka A 44 %, 0 42 %, B 10 % og AB 4 %). Beregn forskellen i procentpoint for hver type: klassens andel minus referenceandelen. Sammenlign RhD+ og RhD− separat, hvis der er referenceværdier. Diskutér, hvad klassens størrelse betyder for sammenligningen.
