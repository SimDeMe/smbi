...
: Iagttagelser af de fire sedimentprøver før forsøget. {#tbl-1}
...
: Opsamlet vandmængde (mL) over tid for hver jordtype. Tilføj flere rækker, hvis vandet stadig siver igennem efter 60 sekunder. {#tbl-2}
...
: Målt volumen af klart vand oven på det bundfældede sediment for hver jordtype. {#tbl-3}
...
: Beregnet porøsitet for hver af de fire jordtyper. {#tbl-4}
...
: Markkapacitet beregnet som 100 mL minus den gennemløbne vandmængde. {#tbl-5}
