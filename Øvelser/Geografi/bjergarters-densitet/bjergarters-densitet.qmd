...
- Digital vægt med tarafunktion, der kan veje op til ca. 2 kg
...
3. Sammenlign med tabelværdien i @tbl-2, og beregn afvigelsen i procent. Brug midten af intervallet som tabelværdi:

$$\text{afvigelse} = \frac{\rho_\text{målt} - \rho_\text{tabel}}{\rho_\text{tabel}} \cdot 100\ \%$$

| Bjergart | Rumfang (cm³) | Målt densitet (g/cm³) | Tabelværdi (g/cm³) | Afvigelse (%) |
|:---|:-:|:-:|:-:|:-:|
| Granit | | | 2,6–2,7 | |
| Basalt | | | 2,9–3,0 | |
| Peridotit | | | 3,2–3,4 | |
...
: Beregnede værdier og sammenligning med typiske tabelværdier. {#tbl-2}

4. Sæt de fire bjergarter i rækkefølge efter jeres målte densitet, og sammenlign med jeres hypotese.
5. @fig-profil viser et snit fra en midtoceanisk ryg til et kontinent. Find ud af, hvilken bjergart der hører til i hvert af felterne A–D, og udfyld @tbl-3.

![Snit fra en midtoceanisk ryg over oceanbunden til en subduktionszone under et kontinent. Pilene viser, hvordan pladerne bevæger sig.](figurer/profil.svg){#fig-profil width="100%"}

| Felt | Del af Jorden | Bjergart | Målt densitet (g/cm³) |
|:-:|:---|:---|:-:|
| A | | | |
| B | | | |
| C | | | |
...
: Bjergarterne placeret i snittet. {#tbl-3}
...
7. Hvor godt repræsenterer én håndstor sten en hel del af Jorden? Diskutér, hvad der kunne gøre jeres resultat mere sikkert.
